abstract class EndPoints{
  ...
  static const String deleteApartment='/api/Apartment';
  static const String getApartmentForSignUser='/api/Apartment/GetApartmentForSignInUser';
  static const String putApartment='/api/Apartment';
  static const String addReport = '/api/Report';
  static const String getMyReports = '/api/Report/GetMyReports';
  static const String postDepartment = '/api/Department';
 static const String deleteReport = '/api/Report/RemoveReport';
