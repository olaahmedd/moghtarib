...
//     return Scaffold(
//       backgroundColor: const Color(0xFF121212), // خلفية داكنة متطابقة
//       appBar: AppBar(
...
//                         color: const Color(0xFF1E1E1E), // لون الكارد الداكن
//                         borderRadius: BorderRadius.circular(20),
//                       ),
//                       child: Column(
//                         crossAxisAlignment: CrossAxisAlignment.start,
//                         children: [
//                           // 1️⃣ الصورة مع زرار الحذف العائم فوقها لعدم تخريب التصميم
//                           Stack(
//                             children: [
//                               ClipRRect(
//                                 borderRadius: const BorderRadius.vertical(top: Radius.circular(20)),
//                                 child: apartment['baseImage'] != null
//                                     ? Image.network(
//                                         'https://mo3tarib123.runasp.net${apartment['baseImage']}',
//                                         height: 200,
...
//                                       ),
//                               ),
//                               // زرار الحذف المخصص ذو شكل دائري مميز
//                               Positioned(
//                                 top: 12,
//                                 right: 12,
...
//                           // 2️⃣ تفاصيل الشقة داخل الكارد
//                           Padding(
//                             padding: const EdgeInsets.all(16.0),
//                             child: Column(
//                               crossAxisAlignment: CrossAxisAlignment.start,
//                               children: [
//                                 // العنوان الرئيسي (القرية والمدينة)
//                                 Text(
...
//                                 // 3️⃣ الـ Badges التوضيحية (غرف - إيجار/بيع - نوع العقار)
//                                 Row(
//                                   children: [
...
//                                 // 4️⃣ السعر المكتوب أسفل الكارد بشكل بارز
//                                 Row(
...
//                                       ],
//                                     ),
//                                     // زرار التفاصيل الجانبي كـ عنصر جمالي لإتمام الـ Card
//                                     Container(
//                                       padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 10),
//                                       decoration: BoxDecoration(
//                                         color: const Color(0xFF6C63FF), // نفس لون البنفسجي الماستر عندك
...
//   // دالة مساعدة لبناء الـ Badges الرمادية والملونة الصغيره الملحقة بالكارد
