...
// 💡 مهم للتعامل مع ملفات الصور الفعليّة File
...
//                 SizedBox(height: 6),
//                 Text(
//                   'Add and manage real estate properties',
...
//                 // 💡 الاستماع لحالة الفشل لمعرفة سبب رفض الـ API للطلب
...
//                                   backgroundColor: const Color(0xFF6F32E4),
...
//       // ✅ تم الإصلاح هنا: استخدام الـ Constructor الصحيح للمكتبة للـ decimals والـ numbers
